...
import { useUserResearchPapersByTypeQuery } from "@/libs/services/queries/research-paper.query";
import { useState } from "react";

export default function PreviousUploadsFeature() {

  const [activeTab, setActiveTab] = useState("journal");

  const { data } = useUserResearchPapersByTypeQuery({ type: activeTab })
